                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body d-flex flex-column">
                                                    ...
                                                    <p class="card-text text-muted small">
                                                        <b>Estado:</b> <?php echo htmlspecialchars($cap['estado_curso']); ?><br>
                                                        <b>Fecha de Inscripción:</b> <?php echo htmlspecialchars($cap['fecha_de_inscripcion']); ?>
                                                    </p>

                                                    <!-- Botón Iniciar -->
                                                    <div class="d-flex justify-content-end mt-3">
                                                        <a href="404.html?id=<?php echo $cap['id']; ?>" class="btn btn-primary btn-sm">
                                                            Iniciar
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade" id="solicitudes" role="tabpanel" aria-labelledby="solicitudes-tab">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <button class="btn btn-success" data-bs-toggle="modal" 
                                    ...
                                    <i class="fas fa-plus me-2"></i> Solicitar Recolección
                                </button>
                            </div>
...
<!-- Incluir controlador para obtener solicitudes -->
                  ...
                  <?php foreach ($solicitudes as $sol): ?>
                    <div class="col-12 col-md-6 col-lg-3 pb-5">
                      <div class="card">
                        <!-- Imagen de la 
                         itación -->
                        <img src="img/<?php echo htmlspecialchars($sol[7]); ?>" class="card-img-top" alt="Curso">
                        <div class="card-body d-flex flex-column">
                          <!-- Título -->
                          <h5 class="card-title"><?php echo htmlspecialchars($sol[1]); ?></h5>
                          <!-- Descripción -->
                          <p class="card-text text-muted small flex-grow-1">
                          ...
                          <div class="d-flex justify-content-end gap-2 mt-3">
                            ...
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#solicitudModal"
                              onclick="cargarSolicitud('<?php echo $sol[0]; ?>', '<?php echo htmlspecialchars($sol[1]); ?>', '<?php echo ($sol[2]); ?>','<?php echo htmlspecialchars($sol[4]); ?>','<?php echo htmlspecialchars($sol[5]); ?>', '<?php echo $sol[7]; ?>')">
    ...
    // Función para nueva capacitación
 ...
 <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      // Si el hash es #solicitudes, activa la pestaña
      if (hash === "#solicitudes") {
        const tabTrigger = document.querySelector('button[data-bs-target="#solicitudes"]');

        if (tabTrigger) {
          const tab = new bootstrap.Tab(tabTrigger);
          tab.show(); // Mostrar la pestaña de solicitudes
        }
      }
