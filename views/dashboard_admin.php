...
include "../controllers/usuarios/consultaUsuario.php";
?>
...
<body>
                ...
                <div class="card rounded-3 border p-3 pb-2">
                    ...
                    <div class="d-sm-flex align-items-center">
                        ...
                        <div class="avatar avatar-xl mb-2 mb-sm-0">
                            <img class="avatar-img rounded-circle" src="img/<?php echo htmlspecialchars($usu['imagen_perfil']); ?>" alt="Foto de perfil">
                        </div>
                        ...
                        <div class="offcanvas-body p-3 p-xl-0">
                            <div class="navbar navbar-expand-xl">
                                ...
                                <ul class="nav nav-tabs" id="dashboardTabs" role="tablist">
                                    ...
                                    <!-- Pestaña Usuarios-->
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link text-dark" id="usuarios-tab" 
                    ...
                    <div class="tab-content m-5" id="dashboardTabContent">
                        ...
                        <!-- PESTAÑA: Usuarios -->
                        <div class="tab-pane fade" id="usuarios" role="tabpanel" aria-labelledby="usuarioss-tab">
                            
                            <!-- Título-->
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <h4>
                                    <i class="fa-solid fa-users icono me-2"></i>Gestión de Usuarios
                                </h4>
                        ...
                        <div class="tab-pane fade" id="capacitaciones" role="tabpanel" aria-labelledby="capacitaciones-tab">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <button class="btn btn-success" data-bs-toggle="modal" 
                                        data-bs-target="#capacitacionModal" onclick="limpiarFormulario()">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <div class="d-flex justify-content-end gap-2 mt-3">
                                                    <!-- Botón Editar -->
                                                    <button class="btn btn-primary" data-bs-toggle="modal" 
                                                            data-bs-target="#capacitacionModal"
                                                            onclick="cargarCapacitacion('<?php echo $cap['id']; ?>', 
                                                                   '<?php echo htmlspecialchars($cap['nombre']); ?>', 
                                                                   '<?php echo htmlspecialchars($cap['descripcion']); ?>', 
                                                                   '<?php echo $cap['fecha']; ?>', 
                                                                   '<?php echo $cap['duracion']; ?>', 
                                                                   '<?php echo $cap['imagen']; ?>')">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    ...
                                                    <button class="btn btn-outline-danger btn-sm" 
                                                            ...
                                                            onclick="prepararEliminacion(<?= $cap['id'] ?>)">
                                                        <i class="fas fa-trash-alt"></i>
                                                    </button>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        // FUNCIONES PARA GESTIÓN DE CAPACITACIONES
        
        // Función para cargar datos de capacitación en el modal de edición
        function cargarCapacitacion(id, titulo, descripcion, fecha, duracion) {
            // Cambiar título del modal
            document.getElementById('capacitacionModalLabel').textContent = "Editar Capacitación";
            ...
            document.querySelector('[name="duracion"]').value = duracion;
            document.getElementById('idCapacitacion').value = id;

            // Cambiar acción del formulario
            document.getElementById('formCapacitacion').action = "../controllers/capacitaciones/editarCapacitacion.php";

            // Cambiar texto del botón
            document.getElementById('btnSubmit').textContent = "Guardar cambios";
        }

        // Función para limpiar formulario de capacitación (nueva capacitación)
        function limpiarFormulario() {
            // Cambiar título del modal
            document.getElementById('capacitacionModalLabel').textContent = "Nueva Capacitación";
            ...
            document.querySelector('[name="duracion"]').value = "";
            document.getElementById('idCapacitacion').value = "";

            // Cambiar acción del formulario
            document.getElementById('formCapacitacion').action = "../controllers/capacitaciones/registrarCapacitacion.php";

            // Cambiar texto del botón
            document.getElementById('btnSubmit').textContent = "Registrar capacitación";
        }

        // Función para preparar eliminación de capacitación
        function prepararEliminacion(id) {
            // Cambiar el href del botón "Eliminar" con el ID recibido
            document.getElementById('confirmarEliminar').href = '../controllers/capacitaciones/eliminarCapacitacion.php?id=' + id;
        }
